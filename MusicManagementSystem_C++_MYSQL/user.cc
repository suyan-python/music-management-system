...
void login()
{
    ...
    ifstream input("Records.txt"); // read
...
void user_design()
{
    ...
    do
    {
        ...
        case 5:
            cout << "\t\t...Exiting Program...Hope you had wonderful experience\n\n";
            break;
...
void addFav()
{
    ...
    cout << "Would you like to add more Favorite List Music (Y/N): ";
    cin >> choice;
